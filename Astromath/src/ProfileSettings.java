...
public class ProfileSettings extends JPanel 
{
	 ...
	 */
	public ProfileSettings(JLayeredPane lp) 
	{
				...
				lblProfileSettings.setForeground(new Color(0, 195, 255));
				lblProfileSettings.setFont(new Font("a Atmospheric", Font.PLAIN, 30));
				lblProfileSettings.setBounds(68, 77, 782, 96);
				panel_profile.add(lblProfileSettings);
				...
				label_edit.addMouseListener(new MouseAdapter() 
				{
					...
					public void mouseClicked(MouseEvent e) 
					{
						//ProfileSettings panel_profileSet = new ProfileSettings(lp);
