...
public class PracticeSelectWindow extends JPanel {
	...
	/**
	 * This creates the PracticeSelect page, here the student can either be taken to
	 * practice or they can be redirected to the VideoSelection page where they can
	 * learn about the topics they're studying in their grade.
	 */
