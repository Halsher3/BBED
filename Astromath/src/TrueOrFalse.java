	...
	public String[] generateToF(int grade) {
		...
		case 0:
			...
			case 0:
				...
				statement = String.format("%s counts %d %s. %s counts %d. %s is right.", names1[name1Roll], firstNum,
						object[objectRoll].toLowerCase(), names2[name2Roll], secondNum, names1[name1Roll]);
				break;

			case 1:
				statement = String.format("%s counts %d %s. %s counts %d. %s is right.", names1[name1Roll], firstNum,
						object[objectRoll].toLowerCase(), names2[name2Roll], secondNum, names2[name2Roll]);
				break;
			}
		...
		case 1:
			...
			switch (prompt) {
			case 0:
				statement = String.format("%s has %d %s. %s has %d. %s has more.", names1[name1Roll], firstNum,
						object[objectRoll].toLowerCase(), names2[name2Roll], secondNum, names1[name1Roll]);
				break;
			case 1:
				statement = String.format("%s has %d %s. %s has %d. %s has more.", names1[name1Roll], firstNum,
