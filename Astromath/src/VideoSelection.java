...
public class VideoSelection extends JPanel {
	...
	/*
	 * Creates the VideoSelection page. Uses similar code from the TestSelection
	 * page, uses a switch statement to grab the topic selected depending on the
	 * grade.
	 */
	...
	public VideoSelection(JLayeredPane lp, Test test, Student student, Connection con) {
		...
		panel_vidSelect.add(option_bg1);
		...
		panel_vidSelect.add(option_bg2);
		panel_vidSelect.add(option3);
		panel_vidSelect.add(option_bg3);
