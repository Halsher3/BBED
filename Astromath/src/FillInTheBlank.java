/*FillInTheBlank extends Question and contains the following methods: generateFITB
 * This returns a String array with 2 indexes. Index 0 is the prompt that will be used to display the question, and
 * index 1 is the answer which can be used to compare the input answer against to determine correctness.
 * A Switch case statement uses the grade to select appropriate questions primarily using string.format and 2 sets of random numbers.
 */
...
public class FillInTheBlank extends Question {
	...
	public String[] generateFITB(int grade) {
		...
		case 1:
			...
			switch (prompt) {
			case 0:
				statement = String.format("%s has %d %s. %s has %d. Together they have ___.", names1[name1Roll],
						firstNum, object[objectRoll].toLowerCase(), names2[name2Roll], secondNum, names1[name1Roll]);
				break;
			case 1:
				...
				statement = String.format("%s has %d %s. %s has %d. %s has ___ more.", names1[name1Roll], firstNum,
						object[objectRoll].toLowerCase(), names2[name2Roll], secondNum, names1[name1Roll]);
				break;
			}
		...
		case 2:
			...
			statement = String.format("%s has %d %s and %d %s. How much money does %s have?", names1[name1Roll],
					firstNum, object[objectRoll], secondNum, object[objectRoll2], names1[name1Roll]);
