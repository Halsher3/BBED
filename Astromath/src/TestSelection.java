...
public class TestSelection extends JPanel {
	...
	/*
	 * Creates the TestSelection page, uses a switch statement depending on the
	 * student's grade to show either adding and subtracting for K-2 or
	 * Multiplication and Division for 3-4. Once selected, it will pass through two
	 * ints a questionSelect variable and an operand variable to use in
	 * TestQuestions.
	 */
	...
	public TestSelection(JLayeredPane lp, Test test, Student student, Connection con) {
		...
		JEditorPane option_bg1 = new JEditorPane();
		option_bg1.setEditable(false);
		option_bg1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		option_bg1.setBackground(new Color(23, 38, 83));
		option_bg1.setBounds(175, 153, 953, 74);
		panel_testSelect.add(option_bg1);
		...
		JEditorPane option_bg2 = new JEditorPane();
		option_bg2.setEditable(false);
		option_bg2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {

			}
		});
		option_bg2.setBackground(new Color(23, 38, 83));
		option_bg2.setBounds(175, 246, 953, 74);
		panel_testSelect.add(option_bg2);
		...
		JEditorPane option_bg3 = new JEditorPane();
		option_bg3.setEditable(false);
		option_bg3.setBackground(new Color(23, 38, 83));
		option_bg3.setBounds(175, 343, 953, 74);
		panel_testSelect.add(option_bg3);
		...
		JEditorPane option_bg4 = new JEditorPane();
		option_bg4.setEditable(false);
		option_bg4.setBackground(new Color(23, 38, 83));
		option_bg4.setBounds(175, 439, 953, 74);
		panel_testSelect.add(option_bg4);

		JLabel image_astro = new JLabel("");
		image_astro.setIcon(new ImageIcon(".\\Assets\\images\\astro.png"));
		image_astro.setBounds(-99, 291, 400, 475);
		panel_testSelect.add(image_astro);

		JLabel image_rocket = new JLabel("");
		image_rocket.setIcon(new ImageIcon(".\\Assets\\images\\rocket.png"));
		image_rocket.setBounds(742, 276, 549, 500);
		panel_testSelect.add(image_rocket);
		...
		try {
			...
			if (rs.next()) {
				...
				quer = "INSERT INTO testinfo(`userID`, `testName1`, `testName2`, `testName3`, `testName4`, `testScore1`, `testScore2`, `testScore3`, `testScore4`) "
						...
						+ "VALUES ('" + student.getAccNum() + "','" + additionTest.getText() + "','"
						+ subtractionTest.getText() + "','" + trueOrFalseTest.getText() + "','"
						+ fillInTheBlankTest.getText() + "','" + 0 + "','" + 0 + "','" + 0 + "','" + 0 + "')";
	...
	public void switch_screen(JPanel p, JLayeredPane lp, Test test, int questionSelect, int operand, Student student,
			Connection con) {
		lp.removeAll();
		p.setLayout(null);
		lp.add(p);
